...
from linkedin.tools import search_industry_trends, analyze_linkedin_engagement
...
content_writer = Agent(
  ...
  backstory="""You are a skilled writer who can mimic Thierry's conversational yet professional tone.
